...
<section class="contact">
	<div class="row  ml-0" id="contatti">
		<div class="container mt-5" >
      	...
      	<div class="col-md-6">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <input type="text" class="form-control mt-2" placeholder="Object" required>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="form-group">
            ...
            <div class="col-12">
              <div class="form-group">
                <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Entrer du texte" rows="3" required></textarea>
              </div>
            </div>
            <div class="col-12">
            <div class="form-group">
        ...
        <i class="fas fa-phone mt-3"></i> <a href="tel:+">(+509) 3849-1285</a><br>
        <i class="fas fa-phone mt-3"></i> <a href="tel:+">(+39) 4374-7773</a><br>
